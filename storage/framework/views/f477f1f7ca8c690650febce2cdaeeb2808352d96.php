...
<head>
  ...
  <title><?php echo $__env->yieldContent('title'); ?> - A</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php endif; ?>
            <li class="nav-item">
              <a href="<?php echo e(route('request_earnings.index')); ?>" class="nav-link">
                <i class="nav-icon fas fa-circle"></i>
                <p>
                  Redeem
                </p>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('package')); ?>" class="nav-link <?php echo e(request()->routeIs('profile') ? 'active' : ''); ?>">
                <i class="nav-icon fas fa-circle"></i>
                <p>
                  Package
                </p>
  ...
  <?php if(session()->has('notify_message')): ?>
  <script>
    $(document).ready(function () {
      make_notify('<?php echo e(session()->get("notify_message")["status"] ?? "success"); ?>', '<?php echo e(session()->get("notify_message")["msg"] ?? ""); ?>')
    });
  </script>
  <?php endif; ?>
...
</html><?php /**PATH C:\Users\THIMIRA\OneDrive - Sri Lanka Institute of Information Technology\Desktop\teddy\resources\views/layouts/app.blade.php ENDPATH**/ ?>